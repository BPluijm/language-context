...
function Header() {
    const {activeLanguage, setEs, setNl} = useContext(LanguageContext);
                ...
                <nav>
                    <ul>
                        ...
                        <li className="language-switch">
                            ...
                            <button className='language-button' type="button" onClick={activeLanguage === 'nl' ? setEs: setNl}>
                                {activeLanguage === "nl" ? <FlagNL/> : <FlagES/>}
                            </button>
                        </li>
                    </ul>
                </nav>
